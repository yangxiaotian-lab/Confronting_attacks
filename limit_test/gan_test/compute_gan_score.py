...
if __name__ == '__main__':
    ...
    test_case_dir = '../../../output/limit_data/gan_data'
    # 使用dataloader读取数据集
    case_test = torchvision.datasets.ImageFolder(test_case_dir, img_transform)
    ...
    print("攻击成功率%.2f%%" % (attack_succ * 100))

    # 写入数据
    gan_ac_score = round(100 - attack_succ * 100, 2)
    ans_dict = {"gan_ac_score": gan_ac_score}
